...
| 2 | Customer interactions | WhatsApp (via Auretris — self-hosted `wacrm` fork, Meta Cloud API Tech Provider; new-client onboarding UI removed 2026-07-31 pending Embedded Signup v4 rebuild) + Phone | script | `.env` at `/home/user/automation_stack` (Meta system-user token) | 2026-07-31 |
